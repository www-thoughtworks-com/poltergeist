...
Poltergeist.WebPage = (function() {
  ...
  WebPage.CALLBACKS = ['onAlert', 'onConsoleMessage', 'onLoadFinished', 'onInitialized', 'onLoadStarted', 'onResourceRequested', 'onResourceReceived', 'onResourceError', 'onError', 'onNavigationRequested', 'onUrlChanged', 'onPageCreated'];
  ...
  WebPage.prototype.onResourceErrorNative = function(resourceError) {
    return console.log('ERROR: PhantomJs returned error ' + resourceError.errorString + ' trying to open ' + resourceError.url);
  };
